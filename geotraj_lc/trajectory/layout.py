...
class ExperimentLayout:
    ...
    def existing_best_model_path(self) -> Path:
        legacy_paths = [
            self.root / "pretrained" / "best" / "tcn_model.pth",
    ...
    def existing_best_normalizer_path(self) -> Path:
        legacy_paths = [
            self.root / "pretrained" / "best" / "normalizer.pkl",
...
def default_experiment(root: str = None) -> ExperimentLayout:
    ...
    best_checkpoint_dir = pretrained_dir / "best"
    return ExperimentLayout(
        root=root_path,
        outputs_dir=outputs_dir,
        cache_dir=outputs_dir / "cache" / "features",
        splits_dir=outputs_dir / "cache" / "splits",
